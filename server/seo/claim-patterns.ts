...
export function getClaimPatternsIndexHtml(): string {
  ...
  return ssrShell({
    ...
    canonical: "https://claimsignal1.com/claims",
...
export function getCarrierClaimsIndexHtml(carrierSlug: string): string | null {
  ...
  return ssrShell({
    ...
    canonical: `https://claimsignal1.com/claims/${carrier.slug}`,
    breadcrumbs: [
...
export function getCarrierLossTypeHtml(carrierSlug: string, lossSlug: string): string | null {
  ...
  return ssrShell({
    ...
    canonical: `https://claimsignal1.com/claims/${carrier.slug}/${lossSlug}`,
    breadcrumbs: [
      { label: "Claim Patterns", href: "/claims" },
    ...
    schemaJson: {
      ...
      url: `https://claimsignal1.com/claims/${carrier.slug}/${lossSlug}`,
