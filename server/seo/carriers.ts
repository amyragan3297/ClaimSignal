...
export function getCarrierIndexHtml(): string {
  ...
  return ssrShell({
    ...
    canonical: "https://Claimsignal1.com/carriers",
    ...
    schemaJson: {
      ...
      url: "https://Claimsignal1.com/carriers",
      itemListElement: CARRIERS.map((c, i) => ({
        "@type": "ListItem",
        position: i + 1,
        name: c.name,
        url: `https://Claimsignal1.com/carriers/${c.slug}`,
      })),
    },
    body,
  });
...
export function getCarrierHtml(slug: string, intel?: CarrierIntelligence): string | null {
  ...
  return ssrShell({
    ...
    canonical: `https://Claimsignal1.com/carriers/${carrier.slug}`,
    breadcrumbs: [
    ...
    schemaJson: {
      ...
      url: `https://Claimsignal1.com/carriers/${carrier.slug}`,
