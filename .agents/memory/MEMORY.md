...
- [AI extraction pipeline](ai-extraction-pipeline.md) — pdf-parse for PDF text, extractClaimFieldsFromText() in ai-services.ts (gpt-5.4, 30+ fields), wired into evidence upload + audio transcription; ExtractionReviewDialog in evidence.tsx; apply via POST /api/evidence/files/:id/apply-extraction.
